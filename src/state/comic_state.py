...
class DynamicLocation(BaseModel):
    ...
    description: str = Field(description="Description of the location (setting, atmosphere, contents)")
...
class ComicState(BaseModel):
    ...
    def get_context_summary(self) -> str:
        ...
        lines = [
            ...
            f"",
            f"Main Character: {self.world.main_character_name} - {self.world.main_character_description[:100]}...",
            f"",
        ...
        if self.world.locations:
            ...
            for loc in self.world.locations:
                lines.append(f"  - {loc.name}: {loc.description[:80]}...")
        ...
        if self.world.characters:
            ...
            for char in self.world.characters:
                ...
                lines.append(f"  - {char.name}: {char.description[:80]}...{loc_info}")
